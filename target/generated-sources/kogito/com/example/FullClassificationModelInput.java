...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "fullClassification", name = "FullClassification", hidden = true)
@ProcessInput(processName = "fullClassification")
public class FullClassificationModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<FullClassificationModel> {
    ...
    @Override()
    public FullClassificationModel toModel() {
        FullClassificationModel result = new FullClassificationModel();
