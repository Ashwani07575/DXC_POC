...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "postClassification", name = "PostClassification", hidden = false)
public class PostClassificationModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<PostClassificationModelOutput> {
    ...
    @Override()
    public PostClassificationModelOutput toModel() {
        PostClassificationModelOutput result = new PostClassificationModelOutput();
        result.setId(getId());
