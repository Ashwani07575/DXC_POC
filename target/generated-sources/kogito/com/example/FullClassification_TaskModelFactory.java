...
public class FullClassification_TaskModelFactory {

    public static TaskModel from(org.kie.kogito.process.WorkItem workItem) {
        switch(workItem.getNodeId().toExternalFormat()) {
            case "_B283FD0C-07B7-499F-8ACB-3FEA90363129":
                return FullClassification__B283FD0C_07B7_499F_8ACB_3FEA90363129_TaskModel.from(workItem);
            default:
