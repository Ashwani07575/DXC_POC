...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "screening", name = "Screening", hidden = false)
public class ScreeningModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ScreeningModelOutput> {
    ...
    @Override()
    public ScreeningModelOutput toModel() {
        ScreeningModelOutput result = new ScreeningModelOutput();
        result.setId(getId());
