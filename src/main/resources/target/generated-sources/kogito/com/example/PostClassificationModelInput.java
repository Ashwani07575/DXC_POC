...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "postClassification", name = "PostClassification", hidden = true)
@ProcessInput(processName = "postClassification")
public class PostClassificationModelInput implements Model, MapInput, MapInputId, MapOutput, MappableToModel<PostClassificationModel> {
    ...
    @Override()
    public PostClassificationModel toModel() {
        PostClassificationModel result = new PostClassificationModel();
